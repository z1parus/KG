...
**Сделано (Фаза 0 + Фаза 1 «Каталог» + Фаза 2 «Корзина и заказ»):**
...
**Дальше (Фаза 3 «Админ-панель»):** роут `/admin/*` в этом же приложении — лента заказов (realtime),
смена статусов, управление меню/наличием, вход по роли `admin`. Затем Фаза 4 — аккаунты/история/push.
